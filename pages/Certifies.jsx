        ...
        <>
            ...
            }
            {
                formaciones.some(f=>f.tipo == 'A') ?
                    <div className="flex flex-col  items-center p-5 mb-10">
...

                        {
                            formaciones.map(
                                ...
                                <div key={formacion.id} 
                                    className="w-200 mb-5
                                    bg-linear-to-br from-slate-900 to-slate-800
                                    transition
                                    shadow-lg
                                    text-gray-200 grid grid-cols-2 border border-slate-700 rounded-lg p-2">
                                    ...
                                    <div className="p-5 flex flex-row-reverse gap-4">
                                        <a href={formacion.siteUrl} target="_blank" rel="noopener noreferrer">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" 
                                                className="size-6   hover:text-white text-gray-400"
                                            >
                                        ...
                                        <div key={formacion.id} 
                                            ...
                                            <div className="p-5 flex flex-row-reverse gap-4">
                                                ...
                                                <a href='#' onClick={()=>{
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6 hover:text-white text-gray-400">  
                                                    <path strokeLinecap="round" strokeLinejoin="round" 
                                                        d="M2.036 12.322a1.012 1.012 0 0 1 0-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178Z" 
                                                    />
                                                    <path strokeLinecap="round" strokeLinejoin="round" d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
